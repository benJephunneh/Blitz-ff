...
const EditorBarMenu: FC<EditorBarMenuProps> = ({ features = {} }) => {
  const { editor, toggleAddingImage, toggleAddingLink } = useContext(editorContext)
  ...
  return (
    ...
    >
      ...
      <EditorBarMenuButton onClick={toggleAddingLink} icon={<FaLink />} label="add link" />

      {features.image && (
        <EditorBarMenuButton onClick={toggleAddingImage} icon={<FaImage />} label="Image" />
      )}
